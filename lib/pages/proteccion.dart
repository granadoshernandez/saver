...
void main() async {
  ...
  runApp(ProteccionPage());
}

class ProteccionPage extends StatelessWidget {
  @override
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Denuncia Ciudadana - Proteccion civil'),
      ),
      body: Container(
...
void enviarEmergencia(Emergency emergency) {
  FirebaseFirestore.instance.collection('tb_proteccion').add({
    'tipo': emergency.tipo,
...
class EmergencyList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: StreamBuilder(
        stream:
            FirebaseFirestore.instance.collection('tb_proteccion').snapshots(),
