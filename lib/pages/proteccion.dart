...
class _ProteccionPageState extends State<ProteccionPage> {
  ...
  TextEditingController _incidentDescriptionController =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Protección Civil"),
        backgroundColor: Colors.orange[900], // Cambia el color de fondo de la barra de navegación
      ),
      body: Padding(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  primary: Colors.orange[900], // Cambia el color del botón
