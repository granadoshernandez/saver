...
class FuerzaPage extends StatefulWidget {
  const FuerzaPage({super.key});

  @override
  State<FuerzaPage> createState() => _FuerzaPageState();
}

class _FuerzaPageState extends State<FuerzaPage> {
